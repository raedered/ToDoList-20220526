...
INSERT INTO `user_dtl` (`user_code`, `profile_img_url`, `create_date`, `update_date`) VALUES
	(2, NULL, '2022-05-24 11:25:54', '2022-05-24 11:25:54'),
	(3, NULL, '2022-05-24 12:58:59', '2022-05-24 12:58:59'),
	(4, NULL, '2022-05-24 12:59:27', '2022-05-24 12:59:27');
...
INSERT INTO `user_mst` (`user_code`, `email`, `name`, `username`, `oauth2_username`, `password`, `roles`, `provider`, `create_date`, `update_date`) VALUES
	(2, 'kjt250018@gmail.com', '김재현', 'google_100254730463524366238', 'google_100254730463524366238', '$2a$10$WmqyNx3UYCMspRPkx4FORu4lF3CCSy0fIdVbF39m6rp7VKcWHXOQq', 'ROLE_USER', 'google', '2022-05-24 11:25:54', '2022-05-24 11:25:54'),
	(3, 'kjh991216@naver.com', '김재현', 'jaehyeon', NULL, '$2a$10$rXURJdGW7SntPW8wtP0o0uFsk2pUftXixwKipizSA.30ZUryOr0we', 'ROLE_USER,ROLE_MANAGER,ROLE_ADMIN', NULL, '2022-05-24 12:58:59', '2022-05-24 12:58:59'),
	(4, 'kjh991216@naver.com', '김재이', 'jaehyeon2', NULL, '$2a$10$qGWKSAtNlyE6pgOqB0OwheI2fZctFI.12ztAYWKgIyHYoNySPebvm', 'ROLE_USER', NULL, '2022-05-24 12:59:27', '2022-05-24 12:59:27');
